---
name: aesop-design
description: Design system skill for aesop. Activate when building UI components, pages, or any visual elements. Provides exact color tokens, typography scale, spacing grid, component patterns, and craft rules. Read references/DESIGN.md before writing any CSS or JSX.
---

# aesop Design System

You are building UI for **aesop**. Light-themed, neutral palette, sans-serif typography (sans-serif), compact density on a 4px grid, flat elevation (no shadows).
...
- **Site URL:** `https://www.aesop.com/tw/`
...
- Creating new components, pages, or visual elements for aesop
- Writing CSS, Tailwind classes, styled-components, or inline styles
- Building page layouts, templates, or responsive designs
- Reviewing UI code for design consistency
- The user mentions "aesop" design, style, UI, or theme
